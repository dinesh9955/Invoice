...
public class ViewPV_Activity extends BaseActivity {
...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewPV_Activity.this) == true){
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewPV_Activity.this));
            if(Utility.isTablet(ViewPV_Activity.this) == true){ // tab
