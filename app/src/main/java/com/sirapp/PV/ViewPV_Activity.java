...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(ViewPV_Activity.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(ViewPV_Activity.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(ViewPV_Activity.this).equalsIgnoreCase("ldpi") ){
