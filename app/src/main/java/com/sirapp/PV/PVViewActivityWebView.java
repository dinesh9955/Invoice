    ...
    private void getinvoicedata() {
        ...
        resposresult.enqueue(new Callback<PVResponseDto>() {
            ...
            public void onResponse(Call<PVResponseDto> call, retrofit2.Response<PVResponseDto> response) {
                ...
                invoiceshre_link = response.body().getData().getPayment_voucher_share_link();
                invoice_image_path = response.body().getData().getPayment_voucher_image_path();
                // customer data get
...
//                        .replaceAll("Bank :", bankstrtxt)
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(PVViewActivityWebView.this));
            if(Utility.isTablet(PVViewActivityWebView.this) == true){ // tab
