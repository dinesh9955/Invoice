...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(InvoiceToReceiptsWebview.this));
            if(Utility.isTablet(InvoiceToReceiptsWebview.this) == true){ // tab
