...
import com.sirapp.R;
import com.sirapp.ThankYouNote.ViewInvoiceActivity;
...
public class ViewInvoice_Activity extends BaseActivity {
...
//            Log.e(TAG,"payment_swiftstrCCC "+payment_swiftstr);
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewInvoice_Activity.this) == true){
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewInvoice_Activity.this));
            if(Utility.isTablet(ViewInvoice_Activity.this) == true){ // tab
