...
//            Log.e(TAG,"payment_swiftstrCCC "+payment_swiftstr);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(ViewInvoice_Activity.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(ViewInvoice_Activity.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(ViewInvoice_Activity.this).equalsIgnoreCase("ldpi") ){
