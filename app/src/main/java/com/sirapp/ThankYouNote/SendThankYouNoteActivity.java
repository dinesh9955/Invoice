...
//    String Grossamount_str_real = "0";
    ...
    private void getinvoicedata() {
        ...
        String token = Constant.GetSharedPreferences(SendThankYouNoteActivity.this, Constant.ACCESS_TOKEN);
...
//                        .replaceAll("Authorized Signatory", signature_of_receivername)
        ...
        invoiceweb.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                //if page loaded successfully then show print button
                //findViewById(R.id.fab).setVisibility(View.VISIBLE);
                final File savedPDFFile = FileManager.getInstance().createTempFile(SendThankYouNoteActivity.this, "ThankYouNote.pdf", true);
...
//                            Uri photoURI = FileProvider.getUriForFile(SendThankYouNoteActivity.this,
//                                    "com.sirapp.provider",
//                                    file);
...
//                                intentShareFile.putExtra(Intent.EXTRA_STREAM, photoURI);
                               ...
                               // File mFile1 = new File(pdf);
                                ...
                                sharingIntent.putExtra(Intent.EXTRA_TEXT,
                                        getString(R.string.select_We_appreciateThank_you));
...
//                                startActivity(sharingIntent);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(SendThankYouNoteActivity.this));
            if(Utility.isTablet(SendThankYouNoteActivity.this) == true){ // tab
