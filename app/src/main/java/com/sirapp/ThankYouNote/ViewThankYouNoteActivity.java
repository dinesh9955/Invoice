...
//        eventValue.put(AFInAppEventParameterName.PARAM_1, "thankyounotes_view");
       // AppsFlyerLib.getInstance().start(ViewThankYouNoteActivity.this, "thankyounotes_view", eventValue);
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewThankYouNoteActivity.this) == true){
...
//                        .replaceAll("Authorized Signatory", signature_of_receivername)
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewThankYouNoteActivity.this));
            if(Utility.isTablet(ViewThankYouNoteActivity.this) == true){ // tab
