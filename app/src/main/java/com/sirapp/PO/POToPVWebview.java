...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(POToPVWebview.this));
            if(Utility.isTablet(POToPVWebview.this) == true){ // tab
