...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(POToPVWebview.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(POToPVWebview.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(POToPVWebview.this).equalsIgnoreCase("ldpi") ){
