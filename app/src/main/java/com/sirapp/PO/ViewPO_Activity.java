...
public class ViewPO_Activity extends BaseActivity {
    ...
    String payment_bank_name = "", paypal_emailstr= "", payment_currency = "", payment_iban = "", payment_swift_bic = "", cheque_payable_to = "";
...
//            invoice_no = String.valueOf(invoicenovalue);
            ...
            cheque_payable_to = getIntent().getStringExtra("cheque_payable_to");
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewPO_Activity.this) == true){
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewPO_Activity.this));
            if(Utility.isTablet(ViewPO_Activity.this) == true){ // tab
