...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(ViewPO_Activity.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(ViewPO_Activity.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(ViewPO_Activity.this).equalsIgnoreCase("ldpi") ){
