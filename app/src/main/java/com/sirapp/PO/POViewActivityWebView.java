...
//                            DecimalFormat formatter = new DecimalFormat("##,##,##,##0.00");
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(POViewActivityWebView.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(POViewActivityWebView.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(POViewActivityWebView.this).equalsIgnoreCase("ldpi") ){
