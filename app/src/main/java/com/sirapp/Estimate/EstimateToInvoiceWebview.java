...
public class EstimateToInvoiceWebview extends BaseActivity {
    ...
    String  payment_bank_name = "", payment_currency = "", payment_iban = "", payment_swift_bic = "", cheque_payable_to ="";
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(EstimateToInvoiceWebview.this));
            if(Utility.isTablet(EstimateToInvoiceWebview.this) == true){ // tab
