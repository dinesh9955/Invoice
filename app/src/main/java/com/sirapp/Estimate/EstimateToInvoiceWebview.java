...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(EstimateToInvoiceWebview.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(EstimateToInvoiceWebview.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(EstimateToInvoiceWebview.this).equalsIgnoreCase("ldpi") ){
