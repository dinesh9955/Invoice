...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    public void view_invoice() {
        ...
        if(Utility.getDensityName(ViewEstimate_Activity.this).equalsIgnoreCase("hdpi") ||
                Utility.getDensityName(ViewEstimate_Activity.this).equalsIgnoreCase("mdpi") ||
                Utility.getDensityName(ViewEstimate_Activity.this).equalsIgnoreCase("ldpi") ){
