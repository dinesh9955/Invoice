...
//    String invoice_name = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("company_id")) {
            ...
            Log.e(TAG, "BlanceamountstrAAA "+Blanceamountstr);
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewEstimate_Activity.this));
            if(Utility.isTablet(ViewEstimate_Activity.this) == true){ // tab
