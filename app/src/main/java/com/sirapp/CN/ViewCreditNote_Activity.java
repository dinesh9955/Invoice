...
//    String invoice_name = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("company_id")) {
            ...
            Gson gson = new Gson();
            String json = gson.toJson(customerselected);
            ...
            if (customerselected.size() >= 1) {
                for (int i = 0; i < customerselected.size(); i++) {
                    if(!customerselected.get(i).getCustomer_name().equalsIgnoreCase("")){
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewCreditNote_Activity.this));
            if(Utility.isTablet(ViewCreditNote_Activity.this) == true){ // tab
