...
//        eventValue.put(AFInAppEventParameterName.PARAM_1, "invoiceRemainder_view");
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewInvoiceReminderActivity.this) == true){
...
//
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewInvoiceReminderActivity.this));
            if(Utility.isTablet(ViewInvoiceReminderActivity.this) == true){ // tab
                ...
                if(screenInches > 4.9 && screenInches < 5.4){
                    ...
                    if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("ldpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_L_V);
                    }else if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("mdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_M_V);
                    }else if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("hdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_H_V);
                    }else if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("xhdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_X_V);
                    }else if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("xxhdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_XX_V);
                    }else if (Utility.getDensityName(ViewInvoiceReminderActivity.this).equalsIgnoreCase("xxxhdpi")){
