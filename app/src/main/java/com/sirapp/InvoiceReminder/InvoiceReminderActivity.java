...
//    private AVLoadingIndicatorView avi;
    ...
    InvoiceReminderAdapter invoicelistAdapterdt;
...
//        overridePendingTransition(R.anim.flip_out, R.anim.flip_in);
      ...
      //  selectcompany = findViewById(R.id.selectcompany);
        ...
        invoicelistAdapterdt = new InvoiceReminderAdapter(InvoiceReminderActivity.this, list);
        recycler_invoices.setAdapter(invoicelistAdapterdt);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(InvoiceReminderActivity.this, LinearLayoutManager.VERTICAL, false);
...
//        });
        ...
        selectcompany1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog mybuilder = new Dialog(InvoiceReminderActivity.this);
...
//                mRecyclerView.setHasFixedSize(true);
                ...
                mRecyclerView.setLayoutManager(new LinearLayoutManager(InvoiceReminderActivity.this, LinearLayoutManager.VERTICAL, false));
...
//                    avi.smoothToHide();
    ...
    private void enableSwipe(){
        SwipeHelper2 swipeHelper = new SwipeHelper2(InvoiceReminderActivity.this, recycler_invoices) {
            @Override
    ...
    private void createbottomsheet_invoiceop(String invoiceidbypos, String ilnvoiceStatus, String pdflink, String sharelink) {
        ...
        if (bottomSheetDialog != null) {
            View view = LayoutInflater.from(InvoiceReminderActivity.this).inflate(R.layout.bottominvoiceview, null);
