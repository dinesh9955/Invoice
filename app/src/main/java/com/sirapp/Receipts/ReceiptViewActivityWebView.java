...
//        colorCode = "#ffffff";
    ...
    private void checkDevice() {
        if(Utility.isTablet(ReceiptViewActivityWebView.this) == true){
...
//                        .replaceAll("Bank :", bankstrtxt)
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ReceiptViewActivityWebView.this));
            if(Utility.isTablet(ReceiptViewActivityWebView.this) == true){ // tab
                ...
                if(screenInches > 4.9 && screenInches < 5.4){
                    ...
                    if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("ldpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_L_V);
                    }else if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("mdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_M_V);
                    }else if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("hdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_H_V);
                    }else if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("xhdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_X_V);
                    }else if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("xxhdpi")){
                        webSettings.setMinimumFontSize(webSettings.getMinimumLogicalFontSize() + AllSirApi.FONT_SIZE_CREATE_XX_V);
                    }else if (Utility.getDensityName(ReceiptViewActivityWebView.this).equalsIgnoreCase("xxxhdpi")){
