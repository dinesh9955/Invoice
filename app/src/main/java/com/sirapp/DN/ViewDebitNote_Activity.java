...
public class ViewDebitNote_Activity extends BaseActivity {

    private static final String TAG = "ViewDebitNote_Activity";
...
//            invoice_no = String.valueOf(invoicenovalue);
    ...
    private void checkDevice() {
        if(Utility.isTablet(ViewDebitNote_Activity.this) == true){
...
//        }, 2000);
    ...
    private void callForWeb() {
        if(invoiceweb != null){
            ...
            Log.e(TAG, "isTablet "+Utility.isTablet(ViewDebitNote_Activity.this));
            if(Utility.isTablet(ViewDebitNote_Activity.this) == true){ // tab
