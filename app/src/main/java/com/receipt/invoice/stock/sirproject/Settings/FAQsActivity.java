...
public class FAQsActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayListNames.add("How to stock value calculated?");
        ...
        arrayListNames.add("How to Mark purchase order as deivery received?");
        ...
        arrayListNames.add("How will I receive the money in my bank account?");
        ...
        invoicelistAdapterdt = new FAQsAdapter(FAQsActivity.this, arrayListNames);
