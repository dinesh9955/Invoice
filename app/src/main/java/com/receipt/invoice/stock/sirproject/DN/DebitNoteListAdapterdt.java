...
public class DebitNoteListAdapterdt extends RecyclerView.Adapter<DebitNoteListAdapterdt.ViewHolderForCat> {

    private Context mcontext;
    ArrayList<InvoiceData> mlist = new ArrayList<>();


    public DebitNoteListAdapterdt(Context mcontext, ArrayList<InvoiceData> list) {
    ...
    @NonNull
    @Override
    public DebitNoteListAdapterdt.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.invoicedetail, viewGroup, false);
        DebitNoteListAdapterdt.ViewHolderForCat viewHolderForCat = new DebitNoteListAdapterdt.ViewHolderForCat(myitem);
        return viewHolderForCat;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final DebitNoteListAdapterdt.ViewHolderForCat viewHolderForCat, final int i) {
