...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent e) {
            ...
            RecyclerView.ViewHolder swipedViewHolder = recycler_invoices.findViewHolderForAdapterPosition(swipedPos);
    ...
    public void attachToRecyclerView(RecyclerView recycler_invoices) {
        this.recycler_invoices = recycler_invoices;
        this.recycler_invoices.setOnTouchListener(onTouchListener);
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(this);
        itemTouchHelper.attachToRecyclerView(this.recycler_invoices);
    }
