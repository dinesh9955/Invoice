...
import com.sir.Invoice.SwipeHelper;
import com.sir.Model.InvoiceData;
import com.sir.R;
...
public class List_of_Estimate extends BaseFragment {
    ...
    EstimateListAdapterdt invoicelistAdapterdt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // COMPANYListingApi();
        setListeners();
        invoicelistAdapterdt = new EstimateListAdapterdt(getContext(), list);
    ...
    private void InvoicelistData(String paramsvalue) {
        ...
        if (paramsvalue.equals("All")) {
           ...
           // Log.e("comany id", selectedCompanyId);
            invoicelistbyurl = "estimate/getListingByCompany";
        } else if (paramsvalue.equalsIgnoreCase("Completed")) {
            params.add("company_id", selectedCompanyId);
            params.add("estimate_status", "3");
            invoicelistbyurl = "estimate/filterbystatus";
        } else if (paramsvalue.equalsIgnoreCase("Pending")) {
            params.add("company_id", selectedCompanyId);
            params.add("estimate_status", "1");
            invoicelistbyurl = "estimate/filterbystatus";
        }
//        else if (paramsvalue.equals("Bydate")) {
//            params.add("company_id", selectedCompanyId);
//            params.add("estimate_status", paramsvalue);
//            invoicelistbyurl = "estimate/getListingByDate";
//        }
        ...
        client.post(AllSirApi.BASE_URL + invoicelistbyurl, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        JSONObject data = jsonObject.getJSONObject("data");
                        JSONArray customer = data.getJSONArray("estimate");
                        for (int i = 0; i < customer.length(); i++) {
                            JSONObject item = customer.getJSONObject(i);
                            invoice_idstr = item.getString("estimate_id");
                            Log.e("invoice_id company", invoice_idstr);
                            String invoice_no = item.getString("estimate_no");
                            String due_date = item.getString("estimate_date");
                          ...
                          //  JSONObject customerobj = item.getJSONObject("customer");
                            ...
                            String status1 = item.getString("status");
...
//                    Fragment_Create_Invoice.defaultClick = 1;
                    ...
                    Intent intent = new Intent(getContext(), EstimateViewActivityWebView.class);
...
//                    Fragment_Create_Invoice.defaultClick = 1;
                    ...
                    Intent intent = new Intent(getContext(), EditEstimateActivity.class);
                    intent.putExtra("invoiceID", invoiceidbypos);
                    intent.putExtra("invoice_count", invoice_count);
...
//
//                                String cc = "android.resource://com.sir/"+R.drawable.a;
//
//                                Uri imgUri=Uri.parse("android.resource://com.sir/"+R.drawable.a);
//
    ...
    private static class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                String newFileName = "Estimate.pdf";
