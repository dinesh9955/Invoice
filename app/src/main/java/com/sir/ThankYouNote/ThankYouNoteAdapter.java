...
public class ThankYouNoteAdapter extends RecyclerView.Adapter<ThankYouNoteAdapter.ViewHolderForCat> {
    ...
    public ThankYouNoteAdapter(Context mcontext, ArrayList<InvoiceData> list) {
    ...
    @NonNull
    @Override
    public ThankYouNoteAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.invoicedetail, viewGroup, false);
        ThankYouNoteAdapter.ViewHolderForCat viewHolderForCat = new ThankYouNoteAdapter.ViewHolderForCat(myitem);
        return viewHolderForCat;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final ThankYouNoteAdapter.ViewHolderForCat viewHolderForCat, final int i) {
