...
import com.sir.Details.User_Detail_Activity;
import com.sir.Model.User_list;
import com.sir.R;
...
public class User_Listing_Adapter extends RecyclerView.Adapter<User_Listing_Adapter.ViewHolderForCat> {
    ...
    public class ViewHolderForCat extends RecyclerView.ViewHolder {
        ...
        public ViewHolderForCat(@NonNull View itemView) {
            ...
            userrole.setTypeface(Typeface.createFromAsset(mcontext.getAssets(),"Fonts/AzoSans-Medium.otf"));
            userdetail.setTypeface(Typeface.createFromAsset(mcontext.getAssets(),"Fonts/Ubuntu-Medium.ttf"));
