...
public class InvoiceReminderAdapter extends RecyclerView.Adapter<InvoiceReminderAdapter.ViewHolderForCat> {
    ...
    public InvoiceReminderAdapter(Context mcontext, ArrayList<InvoiceData> list) {
    ...
    @NonNull
    @Override
    public InvoiceReminderAdapter.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.invoicedetail, viewGroup, false);
        InvoiceReminderAdapter.ViewHolderForCat viewHolderForCat = new InvoiceReminderAdapter.ViewHolderForCat(myitem);
        return viewHolderForCat;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final InvoiceReminderAdapter.ViewHolderForCat viewHolderForCat, final int i) {
