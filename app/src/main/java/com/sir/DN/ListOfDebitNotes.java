...
import com.sir.Invoice.ConvertToReceiptsActivity;
...
public class ListOfDebitNotes extends BaseFragment {

    private static final String TAG = "ListOfDebitNotes";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // COMPANYListingApi();
        setListeners();
        invoicelistAdapterdt = new DebitNoteListAdapterdt(getContext(), list);
...
*/
    ...
    private void InvoicelistData(String paramsvalue) {
        ...
        if (paramsvalue.equals("All")) {
            ...
            invoicelistbyurl = "debitnote/getListingByCompany";
            ...
            params.add("company_id", selectedCompanyId);
            params.add("invoice_status", paramsvalue);
            invoicelistbyurl = "debitnote/getListingByDate";
        }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        JSONArray customer = data.getJSONArray("debit_note");
                        for (int i = 0; i < customer.length(); i++) {
                            JSONObject item = customer.getJSONObject(i);
                            invoice_idstr = item.getString("debit_note_id");
                            Log.e("invoice_id company", invoice_idstr);
                            String invoice_no = item.getString("debit_note_no");
                            String due_date = item.getString("debit_note_date");
    ...
    private static class DownloadFile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                String newFileName = "DebitNote.pdf";
