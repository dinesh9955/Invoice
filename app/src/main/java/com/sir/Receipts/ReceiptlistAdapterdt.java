...
public class ReceiptlistAdapterdt extends RecyclerView.Adapter<ReceiptlistAdapterdt.ViewHolderForCat> {

    private Context mcontext;
    ArrayList<InvoiceData> mlist = new ArrayList<>();


    public ReceiptlistAdapterdt(Context mcontext, ArrayList<InvoiceData> list) {
    ...
    @NonNull
    @Override
    public ReceiptlistAdapterdt.ViewHolderForCat onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View myitem = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.invoicedetail, viewGroup, false);
        ReceiptlistAdapterdt.ViewHolderForCat viewHolderForCat = new ReceiptlistAdapterdt.ViewHolderForCat(myitem);
        return viewHolderForCat;
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull final ReceiptlistAdapterdt.ViewHolderForCat viewHolderForCat, final int i) {
